...
Từ 2026-09-04, Cocos Pilot nâng cấp cơ chế: probe IPC capability khi khởi động/gọi hàm; nếu là Creator 3.8.x thì dùng IPC chuẩn `(project, dotPath, value)`, còn trên Creator 3.7.x thì trả HTTP 422 `UNSUPPORTED_EDITOR_API` kèm recovery action rõ ràng cho Agent.
