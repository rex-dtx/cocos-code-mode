...
export function validateSessionGraph({ cwd = process.cwd(), env = process.env, session, explicitOut = null } = {}) {
  ...
  if (manifest.engineProfile !== ENGINE_PROFILE) return { stale: true, banner: [`engineProfile ${manifest.engineProfile ?? 'missing'} is incompatible; ${ENGINE_PROFILE} required`] };
