...
declare namespace cocos_pilot_3x {
    ...
    function prefabInfo(args: { reference?: InstanceReference, assetPath?: string }): { reference: InstanceReference, url: string, uuid: string, rootNode: unknown, totalEntries: number, components: string[], references: string[] };
    function prefabValidate(args: { reference?: InstanceReference, assetPath?: string, maxReferences?: number }): { valid: boolean, reference: InstanceReference, url: string, uuid: string, references: string[], missingReferences: { id: string }[], issues: { code: string, id: string }[], totalEntries: number };
