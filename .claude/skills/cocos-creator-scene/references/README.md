...
3. [`../../../../docs/cocos-pilot-code-mode-usage.md`](../../../../docs/cocos-pilot-code-mode-usage.md) — Code Mode / Cocos Pilot bootstrap and tool usage.
...
| Cocos Editor automation | `cocos-pilot-code-mode-usage.md`, `cocos-pilot-3x` skill |
