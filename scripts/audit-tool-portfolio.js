...
// registered tool is a post-baseline expansion and may appear as a candidate.
const FROZEN_BASELINE_NAMES = new Set([
  'animationEdit',
  'animationQuery',
  'assetBatchQuery',
  'assetCreate',
...
function main() {
  ...
  const baselineSourceNames = new Set([...sourceNames].filter((name) => FROZEN_BASELINE_NAMES.has(name)));
  ...
  console.log(JSON.stringify({
    ...
    expansionToolCount: [...sourceNames].filter((name) => !FROZEN_BASELINE_NAMES.has(name)).length,
